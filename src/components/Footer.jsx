...
const Footer = () => {
  return (
    <motion.div
      ...
      <div className='container mx-auto flex flex-col md:gap-20 md:flex-row justify-between items-start'>
        <div className='w-full md:w-1/3 mb-8 md:mb-0'>
          <img className='w-10 h-10' src={logoi} alt="" />
          <p className='text-gray-400 mt-4 '>Lorem ipsum dolor sit amet consectetuunt, enim dolor officia?</p>
        </div>
      ...
      <div className='border-t border-gray-500 py-4 mt-10 text-center text-gray-500'>
        Copyright 2024 @ ShopyMe. All Right Reserved
      </div>
    </motion.div>
  )
}
